...
export default function WizardShell({
  ...
  const toggleGroup = (name: string) =>
    setForm(prev => {
      const g = { ...prev.groups };
      const cur = g[name] || { selected: false, doc: 'Reporte LIMS', file: '' };
  ...
  const setGroupDoc = (name: string, doc: string) =>
    setForm(prev => {
      const g = { ...prev.groups };
      g[name] = { ...(g[name] || { selected: true, doc: 'Reporte LIMS', file: '' }), doc };
      return { ...prev, groups: g };
    });
  ...
  const attachGroup = (name: string) =>
    setForm(prev => {
      const g = { ...prev.groups };
      g[name] = { ...(g[name] || { selected: true, doc: 'Reporte LIMS', file: '' }), file: `soporte_${name.toLowerCase().replace(/\s+/g, '_')}.pdf` };
      return { ...prev, groups: g };
    });
          ...
          <div>
            ...
            <div className="mt-[18px]">
              ...
              <AttachButton
                ...
                label="PDF"
                onClick={() => set('protocolo', 'documento_protocolo.pdf')}
              />
            </div>
          </div>
        )}
            ...
            <div className="flex flex-col gap-3.5 mt-[22px]">
              <div>
                ...
                <AttachButton
                  ...
                  label="PDF"
                  onClick={() => set('hojas', 'documento_hojas.pdf')}
                />
              </div>
              <div>
                <label className="block text-[12.5px] font-semibold text-[#44525A] mb-1.5">
                ...
                <AttachButton
                  ...
                  label="PDF"
                  onClick={() => set('bitacoras', 'documento_bitacoras.pdf')}
                />
              </div>
            </div>
