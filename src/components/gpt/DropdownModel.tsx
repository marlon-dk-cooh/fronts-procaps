...
// Proveedores de LLM disponibles. `value` es lo que viaja al backend como
// `model_name`; cámbialo aquí cuando se fije el modelo real de cada proveedor.
const MODELS: Option[] = [
  {
    value: "gpt-5.4",
    label: "LLM - OpenAI",
  ...
  },
  {
    value: "claude",
    label: "LLM - Claude",
    description: "Modelo Anthropic por definir",
  },
  {
    value: "otro",
    label: "LLM - Otro",
    description: "Proveedor alterno por configurar",
  },
];
